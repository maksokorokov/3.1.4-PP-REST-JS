...
public class InitClass {
    ...
    public void init() {
        ...
        userService.saveUser(new User(1L, "Ivan", "Иванов", 11, "111", "111", roleSet1));
        userService.saveUser(new User(2L, "222", "222", 222, "222", "222", roleSet2));
        userService.saveUser(new User(3L, "333", "333", 333, "333", "333", roleSet3));
